  ...
  var Validator = function ( options ) {
    ...
    */
    this.messages = {
      ...
      , regexp:         "Este valor es inválido en este campo."
  ...
  */
  $.fn.parsley.defaults = {
    ...
    , errors: {
      ...
      , errorsWrapper: '<ul style="background-color:red;"></ul>'                                        // do not set an id for this elem, it would have an auto-generated id
      , errorElem: '<li style="color:white;"></li>'                                            // each field constraint fail in an li
      }
    , listeners: {
