<div class="box-body">
	<div class="card-body">
		<div class="row">
			<h2 class="text-center">REPORTE POR CLIENTE</h2>
			<div class="col-md-6"><label>CLIENTE: {{$cliente->NOM_CLI.' '.$cliente->PAT_CLI.' '.$cliente->MAT_CLI}}</label></div>
...
<div class="modal-footer">
	<a href="{{url('reporte-clientes/'.$request->id_cli)}}" target="_blank" class="btn btn-danger pull-right"><i class="fa fa-print"></i> Imprimir</a>
