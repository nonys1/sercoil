...
@section('li_cotizacion_piso','active')
@section('title','COTIZACIÓN DE PISO FLOTANTE')
@section('content')


<form method="POST" action="{{route('cotizacion_piso.guarda')}}" id="form_cotizacion" parsley-validate novalidate>
	{{csrf_field()}}	
	<div class="col-md-12">
		<!-- Custom Tabs -->
		<div class="nav-tabs-custom">
			...
			<div class="tab-content">
				<div class="tab-pane active" id="tab_1">
					<h3 class="text-center text-info">COTIZACIÓN PISO FLOTANTE</h3>
					<div class="row">
						<div class="col-md-4">
...
<script type="text/javascript">
	function calcular(){
		...
		var route= "{{route('cotizacion_piso.calcula')}}";
		$.ajax({
			url: route,           
...
<script type="text/javascript">
	function guardar(){
		var base=$('#base').val();
		var altura=$('#altura').val();
		var route= "{{route('cotizacion_piso.guarda')}}";
		$.ajax({
			url: route,           
			headers: {'X-CSRF-TOKEN': '{{ csrf_token() }}'},
			type: 'POST',     
